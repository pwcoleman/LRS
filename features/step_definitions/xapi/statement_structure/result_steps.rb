...
Given(/^the statement result duration is changed to '\[PT(\d+)H(\d+)M(\d+)\.(\d+)S\]'$/) do |arg1, arg2, arg3, arg4|
  pending # express the regexp above with the code you wish you had
end
...
Given(/^the statement result \[duration\] is changed to '\[not ISO (\d+) formatted\]'$/) do |arg1|
  pending # express the regexp above with the code you wish you had
end
